 ...
 * 查询客户信用额度输出
 * 
 * <p>Java class for QRY_CUST_CREDIT_LIMIT_RES_TYPE complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QRY_CUST_CREDIT_LIMIT_RES_TYPE">
 *   &lt;complexContent>
 ...
 *         &lt;element name="CUST_CREDIT_LIMIT" type="{http://www.w3.org/2001/XMLSchema}anyType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "QRY_CUST_CREDIT_LIMIT_RES_TYPE", propOrder = {
    "pubres",
    "qryres",
    "custcreditlimit"
})
public class QRYCUSTCREDITLIMITRESTYPE {
    ...
    @XmlElement(name = "CUST_CREDIT_LIMIT", namespace = "http://www.chinatelecom.com/crm/comm/", required = true)
    protected List<Object> custcreditlimit;
     ...
     * This is why there is not a <CODE>set</CODE> method for the custcreditlimit property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCUSTCREDITLIMIT().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getCUSTCREDITLIMIT() {
        if (custcreditlimit == null) {
            custcreditlimit = new ArrayList<Object>();
        }
