 ...
 * 查询客户信用度输出
 * 
 * <p>Java class for QRY_CUST_CREDIT_RES_TYPE complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QRY_CUST_CREDIT_RES_TYPE">
 *   &lt;complexContent>
 ...
 *         &lt;element name="CUST_CREDIT" type="{http://www.chinatelecom.com/crm/comm/}CUST_CREDIT_TYPE" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "QRY_CUST_CREDIT_RES_TYPE", propOrder = {
    "pubres",
    "qryres",
    "custcredit"
})
public class QRYCUSTCREDITRESTYPE {
    ...
    @XmlElement(name = "CUST_CREDIT", namespace = "http://www.chinatelecom.com/crm/comm/", required = true)
    protected List<CUSTCREDITTYPE> custcredit;
     ...
     * This is why there is not a <CODE>set</CODE> method for the custcredit property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCUSTCREDIT().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CUSTCREDITTYPE> getCUSTCREDIT() {
        if (custcredit == null) {
            custcredit = new ArrayList<CUSTCREDITTYPE>();
        }
