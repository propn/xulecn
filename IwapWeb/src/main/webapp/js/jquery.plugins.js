...
(function($) {
	...
	$.fn.tabs = function(options, param) {
		...
		// 
		tabsContainer.bind('_resize',
				function() {
					if (tabsContainer.outerWidth() < tabsContainer
							.attr('scrollWidth')) {
						tabsLeftScroll.show();
	...
	function addTab(param) {
		...
		$(
				'<div id="tabs_' + param.id + '_panel" class="tabs-panel">'
						+ param.content + '</div>').appendTo(panelsContainer);
				...
				jscroll : function(j) {
					return this
							.each(function() {
								...
								var dw = $(_self).width(), dh = $(_self)
										.height();// dh = $(_self).height()-1;
								...
								var jscrollhu = jscrollh
										.children(".jscroll-hu");
								var jscrollhc = jscrollh
										.children(".jscroll-hc");
								var jscrollhd = jscrollh
										.children(".jscroll-hd");
								...
								jscrollh
										.hover(
												function() {
													if (Isup == 0) {
														jscrollhu
																.addClass('jscroll-hu-hover');
														jscrollhc
																.addClass('jscroll-hc-hover');
														jscrollhd
																.addClass('jscroll-hd-hover');
													}
												},
												function() {
													if (Isup == 0) {
														jscrollhu
																.removeClass('jscroll-hu-hover');
														jscrollhc
																.removeClass('jscroll-hc-hover');
														jscrollhd
																.removeClass('jscroll-hd-hover');
													}
												});
								...
								jscrollh.height(sh);
								jscrollhc.height(sh - jscrollhu.height()
										- jscrollhd.height());
								if (sch <= dh) {
									jscrollc.css({
										padding : 0
								...
								jscrollh
										.bind(
												...
												function(e) {
													...
													Isup = 1;
													jscrollhu
															.addClass('jscroll-hu-focus');
													jscrollhc
															.addClass('jscroll-hc-focus');
													jscrollhd
															.addClass('jscroll-hd-focus');
													var pageY = e.pageY, t = parseInt($(
															this).css("top"));
													$(document)
															.mousemove(
																	function(e2) {
													...
													$(document)
															.mouseup(
																	function() {
																		Isup = 0;
																		jscrollhu
																				.removeClass('jscroll-hu-focus');
																		jscrollhc
																				.removeClass('jscroll-hc-focus');
																		jscrollhd
																				.removeClass('jscroll-hd-focus');
																		$(
																				document)
																				.unbind(
