...
(function(){ 
	var themeId = "bsn";
	var imagePath = "../../skins/"+themeId+"/messageBox/";   //MessageBox的图片路径
	var template = SystemContext.appContextPath+"/public/components/messageBox/messageBox_Template.htm"; //MessageBox的模板路经
