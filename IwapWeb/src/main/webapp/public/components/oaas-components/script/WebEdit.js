...
function foreColor(){
  if (!validateMode())  return;
  var arr = showModalDialog( gWebAbsPath +"/inc/script/selcolor.htm", "", "dialogWidth:18.5em; dialogHeight:17.5em; status:0");
  if (arr) format('forecolor', arr);
  else Composition.focus();
}
function fortable()
{
if (!  validateMode())  return;
var arr = showModalDialog( gWebAbsPath +"/inc/script/table.htm", "", "dialogWidth:18.5em; dialogHeight:11.5em; status:0");
