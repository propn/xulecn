...
public class XABO2 implements IAction {
	...
	public boolean insert(DynamicDict dto ) throws Exception {
		...
		System.out.println("XA insert(IAction)---->"+(System.currentTimeMillis()-s)) ;
		return true ;
	}
	...
	public boolean update(DynamicDict dto) throws Exception {
		...
		System.out.println("XA update(IAction)---->"+(System.currentTimeMillis()-s)) ;
		return result ;
	}
	...
	public PageModel searchData(DynamicDict dto) throws Exception {
		...
		System.out.println("XA Query(IAction)---->"+(System.currentTimeMillis()-s)) ;
		return result ;
	}
	...
	public List getObjById(DynamicDict dto) throws Exception {
		...
		System.out.println("XA getObjById(IAction)---->"+(System.currentTimeMillis()-s)) ;
		return list ;
	}
	...
	public boolean delete(DynamicDict dto) throws Exception {
		...
		boolean result = new TMasterDAOImpl().deleteByCond(" id="+id) > 0 
			...
			System.out.println("XA delete(IAction)---->"+(System.currentTimeMillis()-s)) ;
		return result ;
