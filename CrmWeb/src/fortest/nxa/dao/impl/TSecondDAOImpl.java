...
import fortest.nxa.dao.TSecondDAO;
import fortest.nxa.vo.TSecondVO;

public class TSecondDAOImpl implements TSecondDAO {

	private String SQL_SELECT = "SELECT ID,S_NAME,S_DESC,F_ID FROM N_SECOND";

	private String SQL_SELECT_COUNT = "SELECT COUNT(*) AS COL_COUNTS FROM N_SECOND";

	private int maxRows;

	private String SQL_INSERT = "INSERT INTO N_SECOND ( ID,S_NAME,S_DESC,F_ID ) VALUES ( ?,?,?,? )";

	private String SQL_UPDATE = "UPDATE N_SECOND SET  ID = ?, S_NAME = ?, S_DESC = ?, F_ID = ? WHERE";

	private String SQL_DELETE = "DELETE FROM N_SECOND WHERE";

	private String SQL_DELETE_BY_WHERE = "DELETE FROM N_SECOND ";
	...
	public boolean update(String whereCond,VO vo) throws DAOSystemException {
		...
		try {
			...
			conn = ConnectionContext.getContext().getConnection("crm1");
			sql.append( "UPDATE N_SECOND SET ID = ?,S_NAME = ?,S_DESC = ?,F_ID = ?" );
