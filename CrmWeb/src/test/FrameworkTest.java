...
/*	public  String testService(String name , String age) throws Exception {
		...
		return DataTranslate._String(ServiceManager.callJavaBeanService("MyAction", "testService" , param)) ;
	}*/
	...
	public  List testActionSQl(String name , String age) throws Exception {
		...
		return DataTranslate._List(ServiceManager.callSQLService("GET_USERLIST", param)) ;
	}
	...
	public static void main(String[] args ) throws Exception{
		FrameworkTest ft = new FrameworkTest() ;
		...
		//action方式 结果处理
		List result = ft.testActionSQl("abc" , "23") ;
