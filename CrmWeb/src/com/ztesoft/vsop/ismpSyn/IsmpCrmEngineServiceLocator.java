...
public class IsmpCrmEngineServiceLocator extends org.apache.axis.client.Service implements com.ztesoft.vsop.ismpSyn.IsmpCrmEngineService {
    ...
    private java.lang.String IsmpCrmEngine_address = "http://134.192.114.249:10100/IsmpCrmEngine/services/IsmpCrmEngine";
    ...
    public com.ztesoft.vsop.ismpSyn.IsmpCrmEngine getIsmpCrmEngine() throws javax.xml.rpc.ServiceException {
    ...
    public com.ztesoft.vsop.ismpSyn.IsmpCrmEngine getIsmpCrmEngine(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ztesoft.vsop.ismpSyn.IsmpCrmEngineSoapBindingStub _stub = new com.ztesoft.vsop.ismpSyn.IsmpCrmEngineSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ztesoft.vsop.ismpSyn.IsmpCrmEngine.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ztesoft.vsop.ismpSyn.IsmpCrmEngineSoapBindingStub _stub = new com.ztesoft.vsop.ismpSyn.IsmpCrmEngineSoapBindingStub(new java.net.URL(IsmpCrmEngine_address), this);
                _stub.setPortName(getIsmpCrmEngineWSDDServiceName());
                return _stub;
            }
        }
