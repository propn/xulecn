/**
 * SendSubRTSVCallbackHandler.java
 *
...
/**
 *  SendSubRTSVCallbackHandler Callback class, Users can extend this class and implement
 *  their own receiveResult and receiveError methods.
 */
public abstract class SendSubRTSVCallbackHandler {
     ...
     */
    public SendSubRTSVCallbackHandler(Object clientData) {
     ...
     */
    public SendSubRTSVCallbackHandler() {
    ...
    public void receiveResultsubResulToUser(
        com.ztesoft.vsop.webservice.vo.SendSubRTToUserResp result) {
    }
