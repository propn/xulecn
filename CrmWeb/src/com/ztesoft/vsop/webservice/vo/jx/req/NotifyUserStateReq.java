...
/**
 *  NotifyUserStateReq bean class
 */
public class NotifyUserStateReq implements org.apache.axis2.databinding.ADBBean {
    /**
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    NotifyUserStateReq.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static NotifyUserStateReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NotifyUserStateReq object = new NotifyUserStateReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NotifyUserStateReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (NotifyUserStateReq) com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
