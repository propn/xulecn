...
/**
 *  NotifyUserFeeTypeReq bean class
 */
public class NotifyUserFeeTypeReq implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for EffectiveDate
     */
    protected java.lang.String localEffectiveDate;
     ...
     */
    protected boolean localPrePaidSystemIDTracker = false;
     ...
     */
    public void setEffectiveDate(java.lang.String param) {
    ...
    public void setPrePaidSystemID(java.lang.String param) {
        if (param != null) {
            ...
            localPrePaidSystemIDTracker = true;
        } else {
            localPrePaidSystemIDTracker = true;
        }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    NotifyUserFeeTypeReq.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localEffectiveDate == null) {
            ...
            xmlWriter.writeCharacters(localEffectiveDate);
        }

        xmlWriter.writeEndElement();

        if (localPrePaidSystemIDTracker) {
            namespace = "";
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "prePaidSystemID",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "effectiveDate"));
    ...
    public static class Factory {
         ...
         */
        public static NotifyUserFeeTypeReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NotifyUserFeeTypeReq object = new NotifyUserFeeTypeReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NotifyUserFeeTypeReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (NotifyUserFeeTypeReq) com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "effectiveDate").equals(
                            reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setEffectiveDate(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
