...
/**
 *  ServiceCapabilitySubscriptionSyncReq bean class
 */
public class ServiceCapabilitySubscriptionSyncReq implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for ServiceCapabilityID
     */
    protected java.lang.String localServiceCapabilityID;
    ...
    /* This type was generated from the piece of schema that had
       name = ServiceCapabilitySubscriptionSyncReq
    ...
    public java.lang.String getServiceCapabilityID() {
        return localServiceCapabilityID;
    }

    /**
     * Auto generated setter method
     * @param param ServiceCapabilityID
     */
    public void setServiceCapabilityID(java.lang.String param) {
        this.localServiceCapabilityID = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ServiceCapabilitySubscriptionSyncReq.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (!namespace.equals("")) {
            ...
            if (prefix == null) {
                ...
                xmlWriter.writeStartElement(prefix, "serviceCapabilityID",
                    namespace);
                xmlWriter.writeNamespace(prefix, namespace);
                xmlWriter.setPrefix(prefix, namespace);
            } else {
                xmlWriter.writeStartElement(namespace, "serviceCapabilityID");
            }
        } else {
            xmlWriter.writeStartElement("serviceCapabilityID");
        }

        if (localServiceCapabilityID == null) {
            // write the nil attribute
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "nil", "1", xmlWriter);
        } else {
            xmlWriter.writeCharacters(localServiceCapabilityID);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "serviceCapabilityID"));

        elementList.add((localServiceCapabilityID == null) ? null
                                                           : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                localServiceCapabilityID));
        ...
        elementList.add(new javax.xml.namespace.QName("", "updateType"));
    ...
    public static class Factory {
         ...
         */
        public static ServiceCapabilitySubscriptionSyncReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ServiceCapabilitySubscriptionSyncReq object = new ServiceCapabilitySubscriptionSyncReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ServiceCapabilitySubscriptionSyncReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ServiceCapabilitySubscriptionSyncReq) com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "serviceCapabilityID").equals(
                            reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setServiceCapabilityID(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "updateType").equals(
                            reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setUpdateType(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
