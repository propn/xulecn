...
/**
 *  ModifySubscriptionReq bean class
 */
public class ModifySubscriptionReq implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for DA
     */
    ...
    /**
     * field for OldVerUserId
     * This was an Array!
     */
    protected java.lang.String[] localOldVerUserId;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localOldVerUserIdTracker = false;
    ...
    public java.lang.String[] getOldVerUserId() {
        return localOldVerUserId;
    }

    /**
     * validate the array for OldVerUserId
     */
    protected void validateOldVerUserId(java.lang.String[] param) {
    }

    /**
     * Auto generated setter method
     * @param param OldVerUserId
     */
    public void setOldVerUserId(java.lang.String[] param) {
        validateOldVerUserId(param);

        if (param != null) {
            //update the setting tracker
            localOldVerUserIdTracker = true;
        } else {
            localOldVerUserIdTracker = true;
        }

        this.localOldVerUserId = param;
    }
     ...
     * @param param java.lang.String
     */
    public void addOldVerUserId(java.lang.String param) {
        if (localOldVerUserId == null) {
            localOldVerUserId = new java.lang.String[] {  };
        }

        //update the setting tracker
        localOldVerUserIdTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localOldVerUserId);
        list.add(param);
        this.localOldVerUserId = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ModifySubscriptionReq.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localOldVerUserIdTracker) {
            if (localOldVerUserId != null) {
                ...
                for (int i = 0; i < localOldVerUserId.length; i++) {
                    if (localOldVerUserId[i] != null) {
                        if (!emptyNamespace) {
                            if (prefix == null) {
                                java.lang.String prefix2 = generatePrefix(namespace);

                                xmlWriter.writeStartElement(prefix2,
                                    "oldVerUserId", namespace);
                                xmlWriter.writeNamespace(prefix2, namespace);
                                xmlWriter.setPrefix(prefix2, namespace);
                            } else {
                                xmlWriter.writeStartElement(namespace,
                            ...
                            xmlWriter.writeStartElement("oldVerUserId");
                        }

                        xmlWriter.writeCharacters(localOldVerUserId[i]);
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2, "oldVerUserId",
                            namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
                        xmlWriter.writeStartElement(namespace2, "oldVerUserId");
                    }
                } else {
                    xmlWriter.writeStartElement("oldVerUserId");
                }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localOldVerUserIdTracker) {
            if (localOldVerUserId != null) {
                ...
                elementList.add(new javax.xml.namespace.QName("", "oldVerUserId"));
                elementList.add(null);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ModifySubscriptionReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ModifySubscriptionReq object = new ModifySubscriptionReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ModifySubscriptionReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ModifySubscriptionReq) com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "oldVerUserId").equals(
                            reader.getName())) {
                    // Process the array and step past its final element's end.
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    while (!loopDone10) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("", "oldVerUserId").equals(
                                        reader.getName())) {
                                nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                        "nil");
                    ...
                    // call the converter utility  to convert and set the array
                    object.setOldVerUserId((java.lang.String[]) list10.toArray(
                ...
                if (reader.isStartElement() &&
                    ...
                    // call the converter utility  to convert and set the array
                    object.setVerUserId((java.lang.String[]) list11.toArray(
