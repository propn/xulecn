...
public class GetSubscriptionRsp  implements java.io.Serializable {
    ...
    private com.ztesoft.vsop.webservice.jx.ismp.rsp.SubInfo[] subInfo;
    ...
    public GetSubscriptionRsp(
           ...
           com.ztesoft.vsop.webservice.jx.ismp.rsp.SubInfo[] subInfo) {
     ...
     * @return subInfo
     */
    public com.ztesoft.vsop.webservice.jx.ismp.rsp.SubInfo[] getSubInfo() {
        return subInfo;
    }
     ...
     * @param subInfo
     */
    public void setSubInfo(com.ztesoft.vsop.webservice.jx.ismp.rsp.SubInfo[] subInfo) {
        this.subInfo = subInfo;
    }
