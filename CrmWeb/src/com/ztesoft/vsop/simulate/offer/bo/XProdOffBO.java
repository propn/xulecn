...
public class XProdOffBO extends DictAction  {
...
//		String streamNo = vs.genReqStreamNo();
		...
		System.out.println("-------PackageInfoSyncReq------------="+resXml);
		return resXml;
//		return xml.toString();
	}
	...
	private static String callRemoteService(int actionType , Map relMap ,String offer_id ) throws Exception{
		...
		String ret=SoapClient.getInstance().xofferSynToVSOP(iSMP2VSOPOfferXML(actionType  , relMap,  result) );
