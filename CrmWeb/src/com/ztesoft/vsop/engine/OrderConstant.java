...
public interface OrderConstant {
	...
	public static final String orderTypeOfChangeUIM = "17"; //换卡
	
	public static final String orderTypeOfModifyServiceFunction = "20"; //改服务功能
	public static final String orderTypeOfTransferUser = "21"; //固话移机
	...
	public static final String VProductActionTypeOfReplace = "02";  //替换已有产品
	...
	public static final String ORDER_ACTIVE_STATE_SUCCESS = "1";  //激活成功
	public static final String ORDER_ACTIVE_STATE_FAIL = "2";  //激活失败
