...
public class OrdServAddrVO extends ValueObject implements VO {
	...
	public void setSeq_(String seq_) {
		this.seq_ = seq_;
	}
	...
	public void loadFromHashMap(HashMap hashMap) {
		if (hashMap != null) {
			...
			this.seq_ = Const.getStrValue(hashMap, "seq_");
