...
public class OrdOffInstAssureVO extends ValueObject implements VO {
	...
	public String getAssure_id() {
		return assure_id;
	}
	
	public void setAssure_id(String assure_id) {
		this.assure_id = assure_id;
	}
	...
	public HashMap unloadToHashMap() {
		...
		hashMap.put("assure_id",this.assure_id);	
	...
	public void loadFromHashMap(HashMap hashMap) {
		if (hashMap != null) {
			...
			this.assure_id = Const.getStrValue(hashMap, "assure_id");
