...
public class OrdCustOrderVO extends ValueObject implements VO {
	

	private String cust_ord_id;
	

	private String cust_so_number;
	...
	public String getCust_so_number() {
		return cust_so_number;
	}
	
	public void setCust_so_number(String cust_so_number) {
		this.cust_so_number = cust_so_number;
	}
	...
	public HashMap unloadToHashMap() {
		...
		hashMap.put("cust_so_number",this.cust_so_number);	
	...
	public void loadFromHashMap(HashMap hashMap) {
		if (hashMap != null) {
			...
			this.cust_so_number = Const.getStrValue(hashMap, "cust_so_number");
