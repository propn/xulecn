...
import com.ztesoft.component.file.requestcycle.UserAction;
 ...
 * {@link com.ztesoft.component.file.requestcycle}.
 * 
...
//	private static UserPathBuilder userPathBuilder = null;
	...
	static {
		...
		String fqcn = PropertiesLoader.getProperty("upload.userActionImpl");
		if (fqcn == null)
...
//		fqcn = PropertiesLoader.getProperty("upload.userPathBuilderImpl");
//		if (fqcn == null)
