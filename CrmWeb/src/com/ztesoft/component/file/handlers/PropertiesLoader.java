 ...
 * <code>/net/fckeditor/handlers/UploadConfig.properties</code> and
 * <code>/fckeditor.properties</code>.<br />
 * This class loads the properties files as follows:
 * <ol>
 * <li>Load <code>UploadConfig.properties</code></li>
 ...
 * <code>UploadConfig.properties</code>. (intended behavior)<br />
 ...
 * 
 * 修改属性文件名称：default.properties > UploadConfig.properties
 * 
 */
public class PropertiesLoader {
	...
	static {
		...
		if (in == null) {
			logger.error("UploadConfig.properties not found");
			throw new RuntimeException("UploadConfig.properties not found");
		} else {
			...
			try {
				properties.load(in);
				in.close();
				logger.debug("UploadConfig.properties loaded");
			} catch (Exception e) {
				logger.error("Error while processing UploadConfig.properties");
				throw new RuntimeException(
						"Error while processing UploadConfig.properties", e);
			}
		}
