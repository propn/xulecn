...
public class TabpaneTag extends BodyTagSupport {
	...
	public String getTitleDiv(){
		...
		if("true".equalsIgnoreCase(this.getMinimizable())){
			...
			sbuffer.append("<IMG title='最小化' id='"+this.getId()+"_minButton' SRC='/VsopWeb/public/skins/bsn/tabset/cmnuMinimize.gif' WIDTH='13' HEIGHT='11' BORDER=0 ALT='' align='center' onclick='minShowPage(\""+this.getId()+"\")' />");	
			sbuffer.append("</td>");
		}
		if("true".equalsIgnoreCase(this.getMaximizable())){
			sbuffer.append("<td class='tabsetTitle_control_max'>");
			sbuffer.append("<IMG title='最大化' id='"+this.getId()+"_maxButton'SRC='/VsopWeb/public/skins/bsn/tabset/cmnuMaximize.gif' WIDTH='13' HEIGHT='11' BORDER=0 ALT='' align='center' onclick='maxShowPage(\""+this.getId()+"\")' />");	
			sbuffer.append("</td>");
		}		
		if("true".equalsIgnoreCase(this.getWindowable())){
			sbuffer.append("<td class='tabsetTitle_control_win'>");
			sbuffer.append("<IMG title='窗口显示' id='"+this.getId()+"_winButton' SRC='/VsopWeb/public/skins/bsn/tabset/cmnuClose.gif' WIDTH='13' HEIGHT='11' BORDER=0 ALT='' align='center' onclick='winShowPage(\""+this.getId()+"\")' />");	
			sbuffer.append("</td>");
		}
