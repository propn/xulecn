...
public class PartyService extends DictService {
	...
	public String getCompanyId() throws Exception {
		GlobalVariableHelper helper = new GlobalVariableHelper(RequestContext
				.getContext().getHttpRequest());
	...
	public boolean checkStaffDefaultPriv(String partyRoleId) throws Exception {
		...
		Object result = ServiceManager.callJavaBeanService("PartyBO",
				"checkStaffDefaultPriv", param);
	...
	public String getStaffOrganizationId() throws Exception {
		GlobalVariableHelper helper = new GlobalVariableHelper(RequestContext
				.getContext().getHttpRequest());
		String staffOrganizationId = helper
	...
	public String getStaffOrganizationName() throws Exception {
		GlobalVariableHelper helper = new GlobalVariableHelper(RequestContext
				.getContext().getHttpRequest());
		String staffOrganizationName = helper
	 ...
	 *            主键
	 * @param type
	 *            类型:1表示REGION表,2表示ORGANIZATION表
	 * @return
	 * @throws Exception
	 */
	...
	public String getSuperStaffCode() {
		String superStaffCode = CrmParamsConfig.getInstance().getParamValue(
				"SUPER_STAFF_CODE");
	...
	public boolean ifSuperManager() {
		...
		// if(
		// superStaffCode.equals(loginRespond.getStaffCode())){//如果是超级管理员工号,则返回所有的电信组织根节点
		// return true ;
		// }else{
		// return false ;
		// }
	 ...
	 * @throws Exception
	 */
	public String[] getAllParentOrganizationIds(String partyId)
			throws Exception {
	...
	public void insertAddrWithLogicalAddr(AddrVO vo,
			LogicalAddrVO[] logicalAddrVOs) throws Exception {
	 ...
	 *            地址标识
	 * @return 操作结果,
	 *         成功时ServiceResult.resultObject为指定地址标识对应的逻辑地址列表(LogicalAddr构成的ArrayList
	 *         )
	 */
	 ...
	 */
	public ArrayList getOrganizationTypesByClass(String org_class)
			throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"getOrganizationTypesByClass");
	 ...
	 */
	public String insertOrganizationType(OrganizationTypeVO vo)
			throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean updateOrganizationType(OrganizationTypeVO vo)
			throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean deleteOrganizationType(String porganizationtype_id)
			throws Exception {
	...
	/**
	 * 插入组织实体 同时生成地址、联系信息、参与人、组织、参与人角色
	 * 
	 * @param vo
	 *            待插入实体
	 * @return 操作结果, 成功时返回参与人标识
	 */
	public void insertTelecomOrganization(OrganizationVO voOrg, AddrVO voAddr)
			throws Exception {
	...
	public void insertPartnerOrganization(OrganizationVO voOrg, AddrVO voAddr)
			throws Exception {
	...
	public String insertOrganization(OrganizationVO voOrg, AddrVO voAddr)
			throws Exception {
	...
	public void insertCompetitorOrganization(OrganizationVO voOrg, AddrVO voAddr)
			throws Exception {

		DynamicDict dto = getServiceDTO("PartyBO",
				"insertCompetitorOrganization");
		Map m = new HashMap();
		m.put("voOrg", voOrg);
		m.put("voAddr", voAddr);
		dto.setValueByName("parameter", m);
	...
	/**
	 * 插入组织实体 同时生成地址、联系信息、参与人、组织、参与人角色、部门信息
	 * 
	 * @param vo
	 *            待插入实体
	 * @return 操作结果, 成功时返回参与人标识
	 */
	public String insertOrganizationWithDepartment(OrganizationVO voOrg,
			AddrVO voAddr, MpDepartVO voDepart) throws Exception {

		DynamicDict dto = getServiceDTO("PartyBO",
				"insertOrganizationWithDepartment");
		Map m = new HashMap();
		m.put("voOrg", voOrg);
		m.put("voAddr", voAddr);
	 ...
	 * @return 操作结果
	 */
	public boolean updateOrganization(OrganizationVO voOrg, AddrVO voAddr)
			throws Exception {
	...
	public String updateOrganizationWithDepartment(OrganizationVO voOrg,
			AddrVO voAddr, MpDepartVO voDepart) throws Exception {

		DynamicDict dto = getServiceDTO("PartyBO",
				"updateOrganizationWithDepartment");
		Map m = new HashMap();
		m.put("voOrg", voOrg);
		m.put("voAddr", voAddr);
		m.put("voDepart", voDepart);
	...
	/**
	 * 删除实体，依次删除： 组织岗位角色控制范围、组织岗位角色、组织岗位、 部门、部门班次、部门终端范围、 联系信息、逻辑地址、地址、参与人识别信息、
	 * 渠道分类、合作伙伴、对等运营商、 参与人
	 * 
	 * @param porganization_id
	 *            组织标识
	 ...
	 *            菜单编码
	 * @param regionType
	 *            区域类型:'0':计费线的地域;'1':资源线地域;'2':营销的地域;'3':营销线的组织
	 * @return
	 * @throws Exception
	 */
	public ArrayList getPrivRegionByMenuCode(String menuCode, String regionType)
			throws Exception {
	...
	public ArrayList getOrganizationByIds(ArrayList ids, String regionType)
			throws Exception {
	...
	public String getRootOrganizationListByPrivControl(String menuCode)
			throws Exception {
		ArrayList privCodeList = getPrivCodeByType("3", menuCode);
	...
	public String getRootOrganizationListByPartyIds(ArrayList regionIds)
			throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"getRootOrganizationListByPartyIds");
		dto.setValueByName("parameter", regionIds);
		dto = ActionDispatch.dispatch(dto);
		return ((String) dto.getValueByName("result"));
	}

	public String getTelecomOrganizationListByParentId(String parentId)
			throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"getTelecomOrganizationListByParentId");
	...
	public String getPrivilegeOrganization(String menuCode) throws Exception {
		...
		// CrmParamsConfig.getInstance().getParamValue("SUPER_STAFF_CODE");
		// if(
		// superStaffCode.equals(loginRespond.getStaffCode())){//如果是超级管理员工号登陆,则返回所有的组织结构
		if (loginRespond.isSuperStaff()) {
		...
		for (int i = 0; i < roleStates.length; i++) {
			for (int j = 0; j < privCodes.size(); j++) {
				...
				if (privCode.equals(roleStates[i].getPrivilegeCode())
						&& "3".equals(roleStates[i].getPermitionFlag())) {
	 ...
	 * @return
	 */
	public String getTelecomOrganizationListByCond(String staffCode,
			String privilegeCode, String orgType) throws Exception {
		Object obj = RequestContext.getContext().getHttpSession()
		...
		DynamicDict dto = getServiceDTO("PartyBO",
				"getTelecomOrganizationListByCond");
		Map m = new HashMap();
	 ...
	 */
	public String insertOrganizationPost(OrganizationPostVO vo)
			throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean updateOrganizationPost(OrganizationPostVO vo)
			throws Exception {
	 ...
	 * @return 操作结果
	 */
	public int deleteOrganizationPost(String porganizationpost_id)
			throws Exception {
	...
	public boolean checkOrganizationPostInUsed(String organizationPostId)
			throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"checkOrganizationPostInUsed");
	...
	public ArrayList queryOrgPosition(String orgId, String postName,
	...
	public ArrayList getDepartByType(String type, String departName,
	 ...
	 */
	public String insertPartyIdentification(PartyIdentificationVO vo,
			String partyRoleId) throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean updatePartyIdentification(PartyIdentificationVO vo)
			throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean deletePartyIdentification(String ppartyidentification_id)
			throws Exception {
	 ...
	 * @param pparty_id
	 *            标识
	 * @return 操作结果, 成功时ServiceResult.resultObject为参与人角色标识对应的参与人识别信息列表（
	 *         PartyIdentificationVO构成的ArrayList）
	 */
	public ArrayList getPartyIdentificationByPartyId(String pparty_role_id)
			throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"getPartyIdentificationByPartyId");
	 ...
	 *            参与人标识
	 * @return 操作结果,
	 *         成功时ServiceResult.resultObject为指定参与人的所有参与人角色列表（PartyRoleVO构成的ArrayList
	 *         ）
	 */
	...
	public PageModel queryOfficeList(String officeDesc, int pageIndex,
	 ...
	 * @throws Exception
	 */
	public PageModel getStaffsByStaffCondPaginate(StaffVO voStaff,
			int pageIndex, int pageSize) throws Exception {

		DynamicDict dto = getServiceDTO("PartyBO",
				"getStaffsByStaffCondPaginate");
		Map m = new HashMap();
	 ...
	 * @throws Exception
	 */
	public String insertBatchStaff(String orgPartyId, String startStaffCode,
			String endStaffCode, String staffName, String orgPostId,
			String state, String effDate, String expDate,
			String channelSegmentId, String password, String lanId,
			String businessId, String countyType, String orgManager,
	 ...
	 * @throws Exception
	 */
	public void copyStaff(String sourcePartyRoleId, String staffCode,
			String staffName, String password) throws Exception {
	...
	public boolean updateStaffState(String party_role_id, String state)
			throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean deleteWorkingOffice(String workingoffice_id)
			throws Exception {
	 ...
	 *            员工参与人角色标识
	 * @return 操作结果,
	 *         成功时ServiceResult.resultObject为指定员工的所有员工岗位列表（StaffPostVO构成的ArrayList
	 *         ）
	 */
	public ArrayList getStaffPostByPartyRoleId(String ppartyrole_id)
			throws Exception {
	...
	public ArrayList getCurrentStaffPost(String orgPartyId) throws Exception {
		...
		// CrmParamsConfig.getInstance().getParamValue("SUPER_STAFF_CODE");
		// if(
		// superStaffCode.equals(helper.getVariable(GlobalVariableHelper.OPER_CODE))){//如果是超级管理员用户,则返回指定组织额所有岗位
		if (loginRespond.isSuperStaff()) {
			return this.getPositionListByPartyId(orgPartyId);
		}
		// return
		// this.getStaffPostByPartyRoleId(helper.getVariable(GlobalVariableHelper.OPER_ID));
	 ...
	 */
	public boolean deleteStaffPost(String porgpost_id, String ppartyrole_id)
			throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO", "checkStaffDefaultPriv");
		Map m = new HashMap();
	 ...
	 */
	public ArrayList getStaffPrivsByPartyRoleId(String ppartyrole_id)
			throws Exception {
	...
	public String getStaffPrivXMLItemByPartyRoleId(String partyRoleId)
			throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"getStaffPrivXMLItemByPartyRoleId");
	...
	public List getStaffPrivilegeRegionInfo(String privilegeId,
			String partyRoleId) throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"getStaffPrivilegeRegionInfo");
		Map m = new HashMap();
	 ...
	 * @return 操作结果, 成功时ServiceResult.resultObject为新建员工权限标识
	 */
	public boolean insertBatchStaffPrivAndScopes(ArrayList staffPrivs)
			throws Exception {
		if (staffPrivs == null || staffPrivs.isEmpty())
			return false;
		DynamicDict dto = getServiceDTO("PartyBO",
				"insertBatchStaffPrivAndScopes");
	...
	public boolean pinsertBatchStaffPrivAndScopes(StaffPrivVO[] staffPrivs)
			throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"pinsertBatchStaffPrivAndScopes");
	...
	public boolean insertStaffPrivAndScopes(String ppartyrole_id,
			String ppriv_id, String pregion_type, String[] pregion_ids)
			throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean deleteStaffPriv(String partyRoleId, String privId,
			String regionId, String regionType) throws Exception {
	...
	public StaffPrivVO getStaffPriv(String partyRoleId, String privId,
			String regionId, String regionType) throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean deleteStaffPrivsByStaff(String ppartyrole_id)
			throws Exception {
	 ...
	 */
	public ArrayList getStaffRolesByPartyRoleId(String staff_id)
			throws Exception {
	...
	public String getCurrentStaffRoleListByName(String roleName)
			throws Exception {
	 ...
	 * @return 操作结果, 成功时ServiceResult.resultObject为新建员工角色标识
	 */
	public boolean insertBatchStaffRoleAndScopes(ArrayList simpleStaffRoleVO,
			String effDate, String expDate) throws Exception {
		DynamicDict dto = getServiceDTO("PartyBO",
				"insertBatchStaffRoleAndScopes");
		...
		SimpleStaffRoleVO[] ssr = new SimpleStaffRoleVO[simpleStaffRoleVO
				.size()];
	 ...
	 * @return 操作结果
	 */
	public boolean deleteStaffRole(String party_role_id, String role_id,
			String region_id, String region_type) throws Exception {
	 ...
	 * @return 操作结果
	 */
	public boolean deleteStaffRolesByStaff(String ppartyrole_id)
			throws Exception {
	...
	public boolean addWorkOffice(String officeDesc, String officeAddr)
			throws Exception {
		insertWorkingOffice(new WorkingOfficeVO("", officeDesc, officeAddr));
		return true;
	}

	public boolean updateWorkOffice(String officeId, String officeDesc,
			String officeAddr) throws Exception {
	...
	public String[] getUserOf10000(String type) throws Exception {
		...
		if ("query".equalsIgnoreCase(type)) {
			staffCode = CrmParamsConfig.getInstance().getParamValue(
					"ACK_QUERY_STAFF_CODE");
			password = CrmParamsConfig.getInstance().getParamValue(
					"ACK_QUERY_STAFF_PWD");
		} else if ("admin".equalsIgnoreCase(type)
				|| "manager".equalsIgnoreCase(type)) {
			staffCode = CrmParamsConfig.getInstance().getParamValue(
					"ACK_MANAGER_STAFF_CODE");
			password = CrmParamsConfig.getInstance().getParamValue(
					"ACK_MANAGER_STAFF_PWD");
		}
		// 对从配置文件中读取出来的密码进行解密
	...
	public String getProjectCode() {
		String projectCode = CrmParamsConfig.getInstance().getParamValue(
				"PROJECT_CODE");
		return projectCode;
	}
}
