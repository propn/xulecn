...
<html>
	<head>
		...
		<script language="javascript" src="js/BillRegionSelect.js"></script>
	</head>
	<body>
		<div id="layoutDefine">
			<ui:layout type="border">
				<ui:pane position="center">
					<ZTESOFT:treelist id="regionTreeView" checkChildren="false" onItemChecked="regionChecked()" onItemClick="clickRegion()" class="treelist" showImage="false" showCheck="true" showBorder="true" contBorder="true" showImage=false showHead=true>
						<ZTESOFT:columns>
