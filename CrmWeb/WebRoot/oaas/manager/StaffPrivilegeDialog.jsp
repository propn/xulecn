...
<html>
	...
	<body>
		...
		<div id="layoutDefine">
			<ui:panel type="modalDialog" desc="人员权限">
				<ui:content>
							...
							<ui:layout type="border">
								...
								<ui:pane position="center">
									<ZTESOFT:treelist id="privilegeTreeView" onItemClick="clickPriv()" onItemChecked="itemChecked()" showCheck="true" class="treelist" showImage="false" showBorder="false" contBorder="true" showImage=false height="230" showHead=true
										...
										<ZTESOFT:columns>
											<ZTESOFT:column width="34%" display="true" displayText="权限名称" propertyName="privName" />
											<ZTESOFT:column width="33%" display="true" displayText="权限描述" propertyName="privDesc" />
											<ZTESOFT:column width="10%" display="true" displayText="权限类型" propertyName="privTypeName" />
											<ZTESOFT:column width="13%" display="true" displayText="是否区域相关" propertyName="ifRegionRelaName" />
											<ZTESOFT:column width="10%" display="false" displayText="权限编码" propertyName="privCode" />											
											...
											<ZTESOFT:column width="" display="false" displayText="权限标识" propertyName="privId" />
								...
								<ui:pane position="center">
									...
									<div id="divRegionTree">
										<ZTESOFT:treelist id="regionTreeView" checkChildren="false" onItemClick="clickRegion()" onItemChecked="regionChecked()" class="treelist" showImage="false" showCheck="true" showBorder="true" contBorder="true" showImage=false width="100%"
											...
											<ZTESOFT:columns>
												<ZTESOFT:column width="43%" display="true" displayText="区域名称" propertyName="regionName" />
												<ZTESOFT:column width="13%" display="true" displayText="区域编码" propertyName="regionCode" />
												<ZTESOFT:column width="43%" display="true" displayText="区域描述" propertyName="regionDesc" />
									...
									<div id="divOrganizationTree" style="display:none">
										<ZTESOFT:treelist id="organizationTreeView" onItemClick="clickOrganization()" checkChildren="false" onItemChecked="organizationChecked()" class="treelist" showImage="false" showCheck="true" showBorder="true" contBorder="true" showImage=false
											...
											<ZTESOFT:columns>
												<ZTESOFT:column width="43%" display="true" displayText="组织名称" propertyName="orgName" />
												<ZTESOFT:column width="13%" display="true" displayText="组织编码" propertyName="orgCode" />
												<ZTESOFT:column width="43%" display="true" displayText="组织简介" propertyName="orgContent" />
