...
function btn_commitRole_onClick(){
	...
	arr[0] = role;
	if( actionType == "insert" ){//增加操作
		ajaxCall.remoteCall("PrivilegeService","insertRole",arr,callBack);
	}else if ( actionType == "update" ){//编辑操作
		ajaxCall.remoteCall("PrivilegeService","updateRole",arr,callBack);
	}
}
