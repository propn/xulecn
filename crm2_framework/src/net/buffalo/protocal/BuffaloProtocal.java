...
//	}
	//modify by AyaKoizumi 101101
	public String marshall(Object value, Writer writer) {
		FastStreamWriter _writer=new FastStreamWriter(writer);
		marshallingStrategy.marshal(value, converterLookup, _writer);
		return _writer.getQuickWriterText();
	}
