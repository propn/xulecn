...
public class PaneTag extends BodyTagSupport {
	...
	private String paneDivId="";
	private String paneId="";//PPMWeb 同上
	...
	public String getPaneDivId() {
		return paneDivId;
	}
	public void setPaneDivId(String paneDivId) {
		this.paneDivId = paneDivId;
	}
	...
	public int doEndTag() throws JspException {		
		...
		if(layout!=null){
			if("top".equalsIgnoreCase(this.getPosition())){  
				...
				if(null != this.getPaneDivId() && !"".equals(this.getPaneDivId()))
					((LayoutTag)layout).setLeftPane("<div id='"+this.getPaneDivId()+"' class='layout_left'"+this.getStyle()+">"+this.getContent()+"</div>");				
				else //旧版本
					((LayoutTag)layout).setLeftPane("<div "+getDivId()+" class='layout_left'"+this.getStyle()+">"+this.getContent()+"</div>");				
			}
			else if("center".equalsIgnoreCase(this.getPosition())){
			    ((LayoutTag)layout).setCenterPane("<div "+getDivId()+"  class='layout_center'"+this.getStyle()+">"+this.getContent()+"</div>");				
			}
			else if("right".equalsIgnoreCase(this.getPosition())){
				((LayoutTag)layout).setRightPane("<div "+getDivId()+"  class='layout_right'"+this.getStyle()+">"+this.getContent()+"</div>");				
			}
			else if("bottom".equalsIgnoreCase(this.getPosition())){
				((LayoutTag)layout).setBottomPane("<div "+getDivId()+"  class='layout_bottom'"+this.getStyle()+">"+this.getContent()+"</div>");								
			}
