...
//import com.ztesoft.component.common.signon.SignOnKeys;
...
//		//初始化session的东西到线程变量 add by AyaKoizumi 100914
//		try{
//			HashMap rtnHashMap =(HashMap) RequestContext.getContext().getHttpSession().getAttribute("LoginRtnParamsHashMap");
//			if(rtnHashMap!=null && !rtnHashMap.isEmpty())
//			SignOnKeys.set("LoginRtnParamsHashMap", rtnHashMap);
//		}
//		catch(Throwable ex){
////			ex.printStackTrace();
//		}
