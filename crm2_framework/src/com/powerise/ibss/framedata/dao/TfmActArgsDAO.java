...
public class TfmActArgsDAO extends AbstractDAO {
	 ...
	 * 
	 */
	public List translateInsertParams(Map hashMap) throws FrameException {
		if (hashMap == null || hashMap.isEmpty())
			return null;
		List params = new ArrayList();

		// params.add(map.get(BatchTempDataVO.)) ;

		params.add(hashMap.get("arg_seq"));

		params.add(hashMap.get("arg_data_type"));

		params.add(hashMap.get("arg_length"));

		params.add(hashMap.get("arg_name"));

		params.add(hashMap.get("in_out_flag"));
