...
public class Base {
	...
	private static int sql__update(Connection conn, int ecode, String sql,
		...
		if (para != null) {
			...
			System.out.println("查询结果信息列表,插入信息:=====================" + sqlTemp);
		}
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * [PCODE]=[00A, 00H, 00X] [PNAME]=[有效, 已归档, 注销] [PKEY]=[00A, 00H,
			 * 00X]
			 *
			 */
			 ...
			 * {STYPE=100001, COMMENTS=, PCODE=00H, PNAME=已归档, PKEY=00H},
			 * {STYPE=100001, COMMENTS=, PCODE=00X, PNAME=注销, PKEY=00X}] List
