...
import org.leixu.iap.person.dao.PersonDao;
...
public class UserDaoTest extends TestCase {
	...
	public UserDaoTest(String s) {
		super(s);
		factory = new ClassPathXmlApplicationContext(new String[]{"test-applicationContext.xml"});
	}
	...
	public void testIterateByWeight() throws Exception {
		...
		Iterator<Person> byWeight = personDao.iterateByWeight(person1
				.getWeight());
