...
import org.leixu.iwap.json.parser.ContainerFactory;
...
public class Test extends TestCase {
	...
	public void testDecode() throws Exception {
		...
		assertEquals("{\"2\":{\"3\":{\"4\":[5,{\"6\":7}]}}}", obj2.get("1")
				.toString());
		...
		try {
			...
			assertEquals(ParseException.ERROR_UNEXPECTED_TOKEN,
					pe.getErrorType());
		...
		try {
			...
			assertEquals("{\"first\":123,\"second\":[4,5,6],\"third\":789}",
			...
			while (!keyFinder.isEnd()) {
				...
				if (keyFinder.isFound()) {
					...
					if (i == 2) {
						...
						assertEquals("123",
								String.valueOf(keyFinder.getValue()));
					}
					if (i == 3)
	...
	public void testEncode() throws Exception {
		...
		System.out.println();
		assertEquals(
				"{\"array1\":[\"abc\\u0010a\\/\",123,222.123,true],\"weight\":60.21,\"age\":27,\"name\":\"fang\",\"is_developer\":true}",
				obj1.toString());
		...
		System.out.println();
		assertEquals(
				"[\"abc\\u0010a\\/\",123,222.123,true,{\"weight\":60.21,\"age\":27,\"name\":\"fang\",\"is_developer\":true}]",
				array1.toString());
		...
		System.out.println();
		assertEquals("[\"abc\\u0010a\\/\",123,222.123,true,null]",
		...
		System.out.println();
		assertEquals(
				"{\"array1\":[\"abc\\u0010a\\/\",123,222.123,true,null],\"weight\":60.21,\"age\":27,\"name\":\"fang\",\"is_developer\":true}",
