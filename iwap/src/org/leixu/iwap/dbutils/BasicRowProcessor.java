 ...
 */
package org.leixu.iwap.dbutils;
...
public class BasicRowProcessor implements RowProcessor {
     ...
     *
     * @see dbutils.RowProcessor#toArray(java.sql.ResultSet)
     ...
     * @see dbutils.RowProcessor#toBean(java.sql.ResultSet, java.lang.Class)
     * @see dbutils.BeanProcessor#toBean(java.sql.ResultSet, java.lang.Class)
     ...
     * @see dbutils.RowProcessor#toBeanList(java.sql.ResultSet, java.lang.Class)
     * @see dbutils.BeanProcessor#toBeanList(java.sql.ResultSet, java.lang.Class)
     * @param <T> The type of bean to create
     * @param rs ResultSet that supplies the bean data
     * @param type Class from which to create the bean instance
     * @throws SQLException if a database access error occurs
     ...
     * @see dbutils.RowProcessor#toMap(java.sql.ResultSet)
