...
<html>
	<head>
		...
		<script language="javascript" src="nxa.js"></script>
	...
	<body>
		<div id="datasetDefine">	
			...
			<ui:dataset datasetId="dsQuery">
				<ui:field field="mName" label="主表名称" visible="true"></ui:field>
			</ui:dataset>
			
			<ui:dataset datasetId="dsList" staticDataSource="true" loadDataAction="NXAService" loadDataActionMethod="searchData" 
			    ...
			    <ui:field field="mName" label="主表名称" visible="true"></ui:field>
				<ui:field field="mDesc" label="主表描述信息" visible="true"></ui:field>
				<ui:field field="sName" label="子表名称" visible="true"></ui:field>
				<ui:field field="sDesc" label="子表描述信息" visible="true"></ui:field>		
			</ui:dataset>
