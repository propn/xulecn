function page_onLoad(){
	...
	var staffIds = window.dialogArguments[4];
...
function getStaffByOrgId(){ 
	...
	var proType = window.dialogArguments[3]; 
	...
	staff["PromotionType"] = proType;//促销人类型 
	//old_alert(staff["PromotionType"] +"--"+staff["orgPartyId"] +"--"+ staff["scope"] +"--"+ staff["staffCode"] +"--"+ staff["partyName"]);	
