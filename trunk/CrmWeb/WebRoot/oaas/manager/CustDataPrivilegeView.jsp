	...
	<body>
		<div id="datasetDefine">
			...
			loadDataActionMethod="getCustDataPrivilegeByPrivilegeId" staticDataSource="true">
				...
				<ui:field field="dataPkey3" label="客户类型" visible="true" attrCode="CUST_TYPE"></ui:field>
				<ui:field field="dataPkey2" label="" visible="false"></ui:field>
				<ui:field field="dataPkey1" label="" visible="false"></ui:field>
				<ui:field field="datasetName" label="数据集名称" visible="true"></ui:field>
				<ui:field field="fieldName" label="数据项名称" visible="true"></ui:field>				
			</ui:dataset>
		</div>
