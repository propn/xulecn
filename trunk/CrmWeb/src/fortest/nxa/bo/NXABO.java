...
//public class NXABO implements IAction  {
...
//			
//	}
public class NXABO extends DictAction  {
	...
	public boolean insert(DynamicDict dto) throws Exception {
		...
		System.out.println("NXA insert---->"+(System.currentTimeMillis()-s)) ;
		return true ;
	}
	...
	public boolean update(DynamicDict dto) throws Exception {
		...
		System.out.println("NXA update---->"+(System.currentTimeMillis()-s)) ;
		return result ;
	}
	...
	public List getObjById(DynamicDict dto) throws Exception {
		...
		if("".equals(id))
			return new ArrayList();
		List result = new TMasterDAOImpl().findByCond(" id="+id) ;
		System.out.println("NXA getObjById---->"+(System.currentTimeMillis()-s)) ;
		return result ;
	}
	...
	public boolean delete(DynamicDict dto) throws Exception {
		...
		boolean result = new TMasterDAOImpl().deleteByCond(" id="+id) > 0 
			...
			System.out.println("NXA delete---->"+(System.currentTimeMillis()-s)) ;
		return result ;
