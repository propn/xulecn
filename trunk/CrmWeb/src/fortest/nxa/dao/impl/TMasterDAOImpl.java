...
import fortest.nxa.dao.TMasterDAO;
import fortest.nxa.vo.TMasterVO;
import fortest.nxa.vo.TSecondVO;

public class TMasterDAOImpl implements TMasterDAO {

	private String SQL_SELECT = "SELECT ID,M_NAME1d,M_DESC FROM N_MASTER";

	private String SQL_SELECT_COUNT = "SELECT COUNT(*) AS COL_COUNTS FROM N_MASTER";

	private int maxRows;

	private String SQL_INSERT = "INSERT INTO N_MASTER ( ID,M_NAME,M_DESC ) VALUES ( ?,?,? )";

	private String SQL_UPDATE = "UPDATE N_MASTER SET  ID = ?, M_NAME = ?, M_DESC = ? WHERE";

	private String SQL_DELETE = "DELETE FROM N_MASTER WHERE";

	private String SQL_DELETE_BY_WHERE = "DELETE FROM N_MASTER ";
	...
	public boolean update(String whereCond,VO vo) throws DAOSystemException {
		...
		try {
			...
			conn = ConnectionContext.getContext().getConnection("crm1") ;
			sql.append( "UPDATE N_MASTER SET ID = ?,M_NAME = ?,M_DESC = ?" );
