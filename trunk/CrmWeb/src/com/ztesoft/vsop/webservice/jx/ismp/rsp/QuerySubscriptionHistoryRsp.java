...
public class QuerySubscriptionHistoryRsp  implements java.io.Serializable {
    ...
    private com.ztesoft.vsop.webservice.jx.ismp.rsp.SubHistoryInfo[] subHistoryInfo;
    ...
    public QuerySubscriptionHistoryRsp(
           ...
           com.ztesoft.vsop.webservice.jx.ismp.rsp.SubHistoryInfo[] subHistoryInfo) {
     ...
     */
    public com.ztesoft.vsop.webservice.jx.ismp.rsp.SubHistoryInfo[] getSubHistoryInfo() {
        return subHistoryInfo;
    }
     ...
     */
    public void setSubHistoryInfo(com.ztesoft.vsop.webservice.jx.ismp.rsp.SubHistoryInfo[] subHistoryInfo) {
        this.subHistoryInfo = subHistoryInfo;
    }
