...
public class IsmpCrmEngineServiceLocator extends org.apache.axis.client.Service implements com.ztesoft.vsop.webservice.jx.ismp.IsmpCrmEngineService {
    ...
    public com.ztesoft.vsop.webservice.jx.ismp.IsmpCrmEngine getIsmpCrmEngine() throws javax.xml.rpc.ServiceException {
    ...
    public com.ztesoft.vsop.webservice.jx.ismp.IsmpCrmEngine getIsmpCrmEngine(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ztesoft.vsop.webservice.jx.ismp.IsmpCrmEngineSoapBindingStub _stub = new com.ztesoft.vsop.webservice.jx.ismp.IsmpCrmEngineSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ztesoft.vsop.webservice.jx.ismp.IsmpCrmEngine.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ztesoft.vsop.webservice.jx.ismp.IsmpCrmEngineSoapBindingStub _stub = new com.ztesoft.vsop.webservice.jx.ismp.IsmpCrmEngineSoapBindingStub(new java.net.URL(IsmpCrmEngine_address), this);
                _stub.setPortName(getIsmpCrmEngineWSDDServiceName());
                return _stub;
            }
        }
