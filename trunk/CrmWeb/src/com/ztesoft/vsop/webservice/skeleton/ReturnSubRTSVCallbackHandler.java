/**
 * ReturnSubRTSVCallbackHandler.java
 *
...
/**
 *  ReturnSubRTSVCallbackHandler Callback class, Users can extend this class and implement
 *  their own receiveResult and receiveError methods.
 */
public abstract class ReturnSubRTSVCallbackHandler {
     ...
     */
    public ReturnSubRTSVCallbackHandler(Object clientData) {
     ...
     */
    public ReturnSubRTSVCallbackHandler() {
    ...
    public void receiveResultsubResultFromVSOP(
        com.ztesoft.vsop.webservice.vo.SendSubRTFromVSOPResp result) {
    }
