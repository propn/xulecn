/**
 * SubsInstQrySVMessageReceiverInOut.java
 *
...
/**
 *  SubsInstQrySVMessageReceiverInOut message receiver
 */
public class SubsInstQrySVMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutSyncMessageReceiver {
    public void invokeBusinessLogic(
        ...
        try {
            ...
            SubsInstQrySVSkeleton skel = (SubsInstQrySVSkeleton) obj;
            ...
            if ((op.getName() != null) &&
                ...
                if ("subInstQryFromVSOP".equals(methodName)) {
                    com.ztesoft.vsop.webservice.vo.SubInstQryFromVSOPReqResponse subInstQryFromVSOPReqResponse1 =
                        null;
                    ...
                    subInstQryFromVSOPReqResponse1 = skel.subInstQryFromVSOP(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            subInstQryFromVSOPReqResponse1, false);
                } else {
