...
/**
 *  ResumeSubscriptionReq bean class
 */
public class ResumeSubscriptionReq implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for ID
     */
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ResumeSubscriptionReq.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static ResumeSubscriptionReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ResumeSubscriptionReq object = new ResumeSubscriptionReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ResumeSubscriptionReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ResumeSubscriptionReq) com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
