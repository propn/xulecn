...
/**
 *  WithdrawSubscriptionReq bean class
 */
public class WithdrawSubscriptionReq implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for ID
     */
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    WithdrawSubscriptionReq.this.serialize(parentQName,
                        factory, xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static WithdrawSubscriptionReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            WithdrawSubscriptionReq object = new WithdrawSubscriptionReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WithdrawSubscriptionReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (WithdrawSubscriptionReq) com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
