...
/**
 *  SuspendSubscriptionReq bean class
 */
public class SuspendSubscriptionReq implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for ID
     */
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    SuspendSubscriptionReq.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static SuspendSubscriptionReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SuspendSubscriptionReq object = new SuspendSubscriptionReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SuspendSubscriptionReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SuspendSubscriptionReq) com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
