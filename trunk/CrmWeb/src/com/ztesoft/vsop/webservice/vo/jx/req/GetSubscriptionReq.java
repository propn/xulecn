...
/**
 *  GetSubscriptionReq bean class
 */
public class GetSubscriptionReq implements org.apache.axis2.databinding.ADBBean {
    /**
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    GetSubscriptionReq.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static GetSubscriptionReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetSubscriptionReq object = new GetSubscriptionReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetSubscriptionReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetSubscriptionReq) com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
