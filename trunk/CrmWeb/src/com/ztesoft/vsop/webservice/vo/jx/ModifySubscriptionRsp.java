...
import com.ztesoft.vsop.webservice.vo.jx.req.ExtensionMapper;


/**
 *  ModifySubscriptionRsp bean class
 */
public class ModifySubscriptionRsp implements org.apache.axis2.databinding.ADBBean {
    /**
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ModifySubscriptionRsp.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static ModifySubscriptionRsp parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ModifySubscriptionRsp object = new ModifySubscriptionRsp();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ModifySubscriptionRsp".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ModifySubscriptionRsp) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
