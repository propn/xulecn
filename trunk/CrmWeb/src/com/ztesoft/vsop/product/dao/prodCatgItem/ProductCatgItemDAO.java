package com.ztesoft.vsop.product.dao.prodCatgItem;
...
public class ProductCatgItemDAO extends AbstractDAO {
	...
	//查询SQL
	private String SQL_SELECT = "select catalog_item_id,parent_catalog_item_id,catalog_id,catalog_item_name,catalog_item_desc,catalog_item_cd,catalog_item_type,order_id,seq,state,oper_date,ord_action_type,ord_no,cancel_ord_no,event_seq,cancel_event_seq,party_id,party_role_id,oper_region_id from PRODUCT_CATALOG_ITEM where 1=1 ";
	
	//	统计总数SQL
	private String SQL_SELECT_COUNT = "select count(*) as col_counts from product_catalog_item where 1=1 ";

	//	insert SQl
	private String SQL_INSERT = "insert into PRODUCT_CATALOG_ITEM (catalog_item_id, parent_catalog_item_id, catalog_id, catalog_item_name, catalog_item_desc, catalog_item_cd, catalog_item_type, order_id, seq, state, oper_date, ord_action_type, ord_no, cancel_ord_no, event_seq, cancel_event_seq, party_id, party_role_id, oper_region_id) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
//	private String SQL_INSERT = "insert into PRODUCT_CATALOG_ITEM (catalog_item_id, parent_catalog_item_id, catalog_id, catalog_item_name, catalog_item_desc, catalog_item_type) values (?,?, ?, ?, ?, ?)";

	//	普通update SQL
	private String SQL_UPDATE = "update PRODUCT_CATALOG_ITEM set catalog_item_id=?, parent_catalog_item_id=?, catalog_id=?, catalog_item_name=?, catalog_item_desc=?, catalog_item_cd=?, catalog_item_type=?, order_id=?, seq=?, state=?, oper_date=?, ord_action_type=?, ord_no=?, cancel_ord_no=?, event_seq=?, cancel_event_seq=?, party_id=?, party_role_id=?, oper_region_id=? where 1=1 ";
	...
	private String SQL_DELETE_KEY = "delete from PRODUCT_CATALOG_ITEM where catalog_item_id=?";
		...
		//	根据主键update SQL
	private String SQL_UPDATE_KEY = "update PRODUCT_CATALOG_ITEM set catalog_item_id=?, parent_catalog_item_id=?, catalog_id=?, catalog_item_name=?, catalog_item_desc=?, catalog_item_cd=?, catalog_item_type=?, order_id=?, seq=?, state=?, oper_date=?, ord_action_type=?, ord_no=?, cancel_ord_no=?, event_seq=?, cancel_event_seq=?, party_id=?, party_role_id=?, oper_region_id=? where catalog_item_id=?";
		
		//	根据主键查询SQL
	private String SQL_SELECT_KEY = "select catalog_item_id,parent_catalog_item_id,catalog_id,catalog_item_name,catalog_item_desc,catalog_item_cd,catalog_item_type,order_id,seq,state,oper_date,ord_action_type,ord_no,cancel_ord_no,event_seq,cancel_event_seq,party_id,party_role_id,oper_region_id from PRODUCT_CATALOG_ITEM where catalog_item_id=? ";
	...
	public List translateInsertParams(Map map) throws FrameException{
		...
		params.add(map.get("catalog_item_cd")) ;
	...
	public List translateUpdateParams(Map vo , List condParas) throws FrameException{
		...
		params.add(vo.get("catalog_item_cd")) ;
