...
public class ProductOfferProcess {
	public static ProductOfferVO parseXml(String xmlStr) throws DocumentException{
		...
		productOfferVO.setPackageID(PackageID);
		...
		productOfferVO.setFeeSetFlag("03");
		productOfferVO.setProdOfferSubType("0");
