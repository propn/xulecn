...
//		String SQL = "SELECT PARTY_ROLE_ID,STAFF_CODE,STAFF_DESC,menu_code,business_id,county_type,CHANNEL_SEGMENT_ID, dev_user_belong FROM STAFF where STAFF_CODE = ?";
		String SQL =SQL_SELECT+ " and s.STAFF_CODE =?";
...
//		计算 totalCount
		...
		if (CrmConstants.DB_TYPE_INFORMIX.equalsIgnoreCase(databaseType)) {
			SQL = DAOSQLUtils.doPreFilter_informix(false,SQL,pageIndex,pageSize);
		} else if (CrmConstants.DB_TYPE_ORACLE.equalsIgnoreCase(databaseType)) {
