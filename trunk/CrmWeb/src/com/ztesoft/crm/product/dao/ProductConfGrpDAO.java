...
public class ProductConfGrpDAO extends AbstractDAO {
	...
	private String SQL_DELETE = "delete from PRODUCT_CONF_GROUP where 1=1 ";
		...
		//	根据主键delete SQL
	private String SQL_DELETE_KEY = "update PRODUCT_CONF_GROUP set state='00X' where conf_group_id=?";
