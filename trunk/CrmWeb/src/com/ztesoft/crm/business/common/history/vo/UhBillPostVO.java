...
public class UhBillPostVO extends ValueObject implements VO {
	...
	public HashMap unloadToHashMap() {
		...
		hashMap.put("contact _name",this.contact_name);	
	...
	public void loadFromHashMap(HashMap hashMap) {
		if (hashMap != null) {
			...
			this.contact_name = Const.getStrValue(hashMap, "contact _name");
