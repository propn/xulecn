...
public class UhNotPayListVO extends ValueObject implements VO {
	...
	private String time_limit_value;
	...
	public String getTime_limit_value() {
		return time_limit_value;
	}
	
	public void setTime_limit_value(String time_limit_value) {
	...
	public void setPan_serial(String pan_serial) {
		this.pan_serial = pan_serial;
	}
	...
	public HashMap unloadToHashMap() {
		...
		hashMap.put("time_limit_value",this.time_limit_value);	
		...
		hashMap.put("pan_serial",this.pan_serial);	
	...
	public void loadFromHashMap(HashMap hashMap) {
		if (hashMap != null) {
			...
			this.time_limit_value = Const.getStrValue(hashMap, "time_limit_value");
			...
			this.pan_serial = Const.getStrValue(hashMap, "pan_serial");
